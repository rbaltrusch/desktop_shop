...
class View(components.View):
    ...
    def create(cls, window, builder):
        ...
        component = Component(main_menu_frame, row=0, col=0, col_span=5, row_span=1, sticky='nsew')
        ...
        component = Component(home_button, row=0, col=0)
        ...
        component = Component(login_button, row=0, col=2, sticky='nsew')
        ...
        component = Component(register_button, row=0, col=1)
        ...
        component = Component(checkout_button, row=0, col=3)
        ...
        component = Component(message_frame, row=0, col=3, col_span=1, sticky='w')
        ...
        component = Component(message_label, row=0, col=0, var=message)
        ...
        component = Component(message_label, row=0, col=0, var=error_message)
