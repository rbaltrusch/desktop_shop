...
def populate_profile_with_user_data():
    ...
    gui.app['profile']['first_name_entry'].config(state='disabled')
    gui.app['profile']['last_name_entry'].config(state='disabled')
    gui.app['profile']['gender_entry'].config(state='disabled')
    gui.app['profile']['date_joined_data_label'].config(state='disabled')
    gui.app['profile']['email_entry'].config(state='disabled')
    gui.app['profile']['dob_entry'].config(state='disabled')
    gui.app['profile']['edit_user_data_button'].config(state='disabled')
