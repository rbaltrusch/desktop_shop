...
COPY LICENSE MANIFEST.in pyproject.toml README.md requirements.txt setup.py ./
COPY desktop_shop desktop_shop
...
#ENTRYPOINT ["desktop_shop"]
CMD python -m desktop_shop
