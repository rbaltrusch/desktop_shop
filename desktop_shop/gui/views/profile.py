...
class View(components.View):
    ...
    def create(cls, window):
        ...
        component = Component(date_joined_frame, row=2, row_span=1, col=1, col_span=3, sticky='nsew')
        ...
        component = Component(date_joined_label, row=0, col=0)
        ...
        component = Component(date_joined_data_label, row=0, col=1, var=date_joined, sticky='w')
        ...
        component = Component(profile_data_frame, row=3, row_span=6, col=1, col_span=3, sticky='new')
        ...
        component = Component(first_name_label, row=0, col=0, sticky='w')
        ...
        component = Component(first_name_entry, row=0, col=1, sticky='w', var=first_name)
        ...
        component = Component(edit_first_name_button, row=0, col=2, sticky='e')
        ...
        component = Component(last_name_label, row=1, col=0, sticky='w')
        ...
        component = Component(last_name_entry, row=1, col=1, sticky='w', var=last_name)
        component.config(state='disabled')
        ...
        component = Component(edit_last_name_button, row=1, col=2, sticky='e')
        ...
        component = Component(gender_label, row=2, col=0, sticky='w')
        ...
        component = Component(gender_entry, row=2, col=1, sticky='w', var=gender)
        component.config(state='disabled')
        ...
        component = Component(edit_gender_button, row=2, col=2, sticky='e')
        ...
        component = Component(email_label, row=3, col=0, sticky='w')
        ...
        component = Component(email_entry, row=3, col=1, sticky='w', var=email)
        component.config(state='disabled')
        ...
        component = Component(edit_email_button, row=3, col=2, sticky='e')
        ...
        component = Component(edit_dob_button, row=4, col=2, sticky='e')
        ...
        component = Component(edit_user_data_button, row=5, col=1, col_span=2, sticky='nse')
        ...
        component = Component(password_frame, row=10, row_span=2, col=1, col_span=3, sticky='nsew')
        ...
        component = Component(password_change_frame_button, row=4, col=2, sticky='w')
        ...
        component = Component(password_change_frame, row=0, row_span=2, col=0, col_span=3)
        ...
        component = Component(pw_label, row=0, col=0)
        ...
        component = Component(pw_entry, row=0, col=1, sticky='nsew', var=password)
        ...
        component = Component(pw_label, row=1, col=0)
        ...
        component = Component(pw_entry, row=1, col=1, sticky='nsew', var=confirm_password)
        ...
        component = Component(password_change_button, row=2, col=1, sticky='e')
